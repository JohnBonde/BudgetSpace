        ...
        <section class="modal-body" id="modalDescription">
          <slot name="body">
            ...
            <input
              ...
              for="transportation"
              required
              v-model="newBudget.transportation"
            />
            ...
            <input
              ...
              for="debt"
              required
              v-model="newBudget.debtPayments"
            />
            <label for="personal">Personal Spending</label>
            <input
              type="number"
              id="personal"
              for="personal"
              required
              v-model="newBudget.personalSpending"
            />
